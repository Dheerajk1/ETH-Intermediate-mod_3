...
contract DheerajErc20 is ERC20           // creating a contract here.
{
    ...
    constructor(uint256 initialSupply) ERC20("KARAN", "DK")  // this constructor is called from openZeppelin repo.
    {
        owner = msg.sender;
